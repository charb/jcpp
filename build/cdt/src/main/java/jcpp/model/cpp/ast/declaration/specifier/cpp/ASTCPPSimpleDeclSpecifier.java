...
public class ASTCPPSimpleDeclSpecifier extends ASTSimpleDeclSpecifier{
	@XmlElement
	...
	public ASTCPPSimpleDeclSpecifier(ICPPASTSimpleDeclSpecifier s) throws Exception{
		super(s);
	...
	public ASTCPPSimpleDeclSpecifier(){
	}
