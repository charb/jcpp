...
cd assembly
jcpp-exe -Dk1=v1 -Dk2=v2 -Dk3=v3 -classpath=jcpp-junit-1.0.dll;core-util-concurrent-1.0.dll;core-tests-1.0.dll -classname=junit.textui.TestRunner jcpp.JCPPTestSuite
cd ..