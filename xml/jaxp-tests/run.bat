...
copy ..\jaxp\target\nar\xml-jaxp-1.0-amd64-Windows-msvc-shared\lib\amd64-Windows-msvc\shared\xml-jaxp-1.0.dll assembly
copy target\nar\xml-jaxp-tests-1.0-amd64-Windows-msvc-shared\lib\amd64-Windows-msvc\shared\xml-jaxp-tests-1.0.dll assembly
cd assembly
jcpp-exe -classpath=jcpp-cli-1.0.dll;core-lang-1.0.dll;jcpp-junit-1.0.dll;core-util-concurrent-1.0.dll;core-tests-1.0.dll;core-util-concurrent-tests-1.0.dll;core-rmi-1.0.dll;core-rmi-tests-1.0.dll;xml-jaxp-1.0.dll;xml-jaxp-tests-1.0.dll -classname=junit.textui.TestRunner jcpp.xml.parsers.ParsersTestSuite
cd ..